...
urlpatterns = [
    ...
    path('delete/<int:pk>/', views.PatientDeleteView.as_view(), name='delete-patient'),
    path('addData/<int:pk>/', views.addData),
    # path('addData/<int:patient_id>/', views.AddClinicalDataView.as_view(), name='add_clinical_data'),
    path('analyze/<int:pk>/', views.analyze_data, name='analyze_data'),
]
